...
function job_setup()
    ...
    state.MarchMode = M{['description']='March Mode', 'Honor', '3', '7', 'Trusts'}
	...
	No_Shoot = S{'Hauksbok Bullet','Animikii Bullet'}
...
function user_setup()
	...
	state.MeleeSet = M{['description']='Melee Set','Leaden','MeleeSTP','Savage','Ranged','Hybrid'}					--'DT', , 'Ranged', 'Leaden', 'Multi'
   ...
   --gear.RAbullet = "Chrono Bullet"
	...
	--send_command('wait 5; lua l autows')
    ...
    send_command('bind @j gs c cycle MarchMode')			--win j
	...
	send_command('bind @z autows on')						--win z
	send_command('bind @x autows off')						--win x
	send_command('bind @1 valk register "Ortlinde\'s Chamber"')
	send_command('bind @2 valk register "Gerhilde\'s Chamber"')
	send_command('bind @3 valk register "Brunhilde\'s Chamber"')
	send_command('bind @4 valk enter')
...
function init_gear_sets()
	...
	organizer_items = {
		...
		silver="Silver Voucher",
		copper="Copper Voucher",
	}
    ------------------------------------------------------------------------------------------------
    ---------------------------------------- Precast Sets ------------------------------------------
    ------------------------------------------------------------------------------------------------
	...
	sets.precast.WS['Sniper Shot'] = set_combine(sets.precast.WS['Wildfire'], {
		})
	...
	sets.engaged.DW.Critical = set_combine(sets.engaged.DW, {
        })
    ...
    sets.engaged.DW.MidAcc.Haste_15 = set_combine(sets.engaged.DW.Haste_15, {
		left_ear="Telos Earring",
        left_ring="Ilabrat Ring",
        right_ring="Regal Ring",
        waist="Kentarch Belt +1",
    ...
    sets.engaged.DW.Critical.Haste_15 = set_combine(sets.engaged.DW.Critical, {
        })
    ...
    sets.engaged.DW.MidAcc.Haste_30 = set_combine(sets.engaged.DW.Haste_30, {
		left_ear="Telos Earring",
        left_ring="Ilabrat Ring",
        right_ring="Regal Ring",
        waist="Kentarch Belt +1",
    ...
    sets.engaged.DW.Critical.Haste_30 = set_combine(sets.engaged.DW.Critical, {
        })
    ...
    sets.engaged.DW.Critical.MaxHaste = set_combine(sets.engaged.DW.Critical, {
        })
	...
	sets.engaged.DW.Critical.DT = set_combine(sets.engaged.DW.Critical, sets.engaged.Hybrid)

    sets.engaged.DW.DT.Haste_15 = set_combine(sets.engaged.DW.Haste_15, sets.engaged.Hybrid)
    sets.engaged.DW.MidAcc.DT.Haste_15 = set_combine(sets.engaged.DW.MidAcc.Haste_15, sets.engaged.Hybrid)
    sets.engaged.DW.HighAcc.DT.Haste_15 = set_combine(sets.engaged.DW.HighAcc.Haste_15, sets.engaged.Hybrid)
    sets.engaged.DW.Critical.DT.Haste_15 = set_combine(sets.engaged.DW.Critical.Haste_15, sets.engaged.Hybrid)

    sets.engaged.DW.DT.Haste_30 = set_combine(sets.engaged.DW.Haste_30, sets.engaged.Hybrid)
    sets.engaged.DW.MidAcc.DT.Haste_30 = set_combine(sets.engaged.DW.MidAcc.Haste_30, sets.engaged.Hybrid)
    sets.engaged.DW.HighAcc.DT.Haste_30 = set_combine(sets.engaged.DW.HighAcc.Haste_30, sets.engaged.Hybrid)
    sets.engaged.DW.Critical.DT.Haste_30 = set_combine(sets.engaged.DW.Critical.Haste_30, sets.engaged.Hybrid)

    sets.engaged.DW.DT.MaxHaste = set_combine(sets.engaged.DW.MaxHaste, sets.engaged.Hybrid)
    sets.engaged.DW.MidAcc.DT.MaxHaste = set_combine(sets.engaged.DW.MidAcc.MaxHaste, sets.engaged.Hybrid)
    sets.engaged.DW.HighAcc.DT.MaxHaste = set_combine(sets.engaged.DW.HighAcc.MaxHaste, sets.engaged.Hybrid)
    sets.engaged.DW.Critical.DT.MaxHaste = set_combine(sets.engaged.DW.Critical.MaxHaste, sets.engaged.Hybrid)
...
function job_post_midcast(spell, action, spellMap, eventArgs)
    ...
    elseif spell.action_type == 'Ranged Attack' then
		...
		elseif state.TreasureMode.value ~= 'None' then
