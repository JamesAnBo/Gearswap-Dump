...
function user_setup()
    ...
    send_command('bind !- gs c cycle targetmode')		--alt -
    send_command('bind !f9 gs c cycle HasteMode')		--alt f9
    send_command('bind !f11 gs c cycle MarchMode')		--alt f11
	send_command('bind ![ gs equip sets.defense.PDT')	--alt [
	send_command('bind !] gs equip sets.defense.MDT')	--alt ]
...
function init_gear_sets()
    ...
    sets.precast.WS['Rudra\'s Storm'].SA = set_combine(sets.precast.WS['Rudra\'s Storm'], {ammo="Yetshila +1", legs="Lustr. Subligar +1", left_ear="Sherida Earring",})
	
    sets.precast.WS['Rudra\'s Storm'].SA.Acc = set_combine(sets.precast.WS['Rudra\'s Storm'].SA, {ammo="Yetshila +1", legs="Lustr. Subligar +1", left_ear="Sherida Earring",})     
    sets.precast.WS['Rudra\'s Storm'].TA = set_combine(sets.precast.WS['Rudra\'s Storm'].SA, {ammo="Yetshila +1", legs="Lustr. Subligar +1", left_ear="Sherida Earring",})
    sets.precast.WS['Rudra\'s Storm'].TA.Acc = set_combine(sets.precast.WS['Rudra\'s Storm'].TA, {ammo="Yetshila +1", legs="Lustr. Subligar +1", left_ear="Sherida Earring",})
    sets.precast.WS['Rudra\'s Storm'].SATA = set_combine(sets.precast.WS['Rudra\'s Storm'].SA, {ammo="Yetshila +1", legs="Lustr. Subligar +1", left_ear="Sherida Earring",})
	...
	sets.precast.WS['Aeolian Edge'] = {
		...
		legs={ name="Herculean Trousers", augments={'Mag. Acc.+20 "Mag.Atk.Bns."+20','Weapon skill damage +5%','"Mag.Atk.Bns."+15',}},
		feet={ name="Herculean Boots", augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','Weapon skill damage +2%','DEX+6','"Mag.Atk.Bns."+15',}},
		neck="Baetyl Pendant",
	...
	sets.AM3 = set_combine(sets.engaged, {
	    ammo="Yetshila +1",
		head={ name="Adhemar Bonnet +1", augments={'DEX+12','AGI+12','Accuracy+20',}},
		waist="Reiki Yotai",
	...
	sets.engaged.MaxCrit = set_combine(sets.engaged, {
		ammo="Yetshila +1",
		head="Mummu Bonnet +2",
		body="Mummu Jacket +2",
		hands="Mummu Wrists +2",
