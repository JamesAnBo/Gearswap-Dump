...
function user_setup()
    ...
    state.HybridMode:options("Normal", "Acc", "TP", "DT", "Bruiser", "Ranged")
   ...
   --[[
	...
	send_command("bind @a gs equip sets.pet.OD_Valoredge; gs disable all")	--VE Overdrive Lock
	send_command("bind @w gs enable all")
...
function init_gear_sets()
    ...
    Artifact_Foire.Body = "Foire Tobe +3" --WSD + Pet HP
    ...
    Relic_Pitre.Legs = "Pitre Churidars +3" --Enhances Ventriloquy + Pet Magic
    Relic_Pitre.Feet = "Pitre Babouches +3" --Enhances Role Reversal + Pet Magic
    ...
    -------------------------------------Fastcast
    sets.precast.FC = {
		head={ name="Herculean Helm", augments={'MND+7','Pet: Haste+3','"Fast Cast"+8','Accuracy+5 Attack+5','Mag. Acc.+11 "Mag.Atk.Bns."+11',}},	--14
		body="Zendik Robe",																															--13
    ...
    sets.precast.JA["Repair"] = {
        ...
        ammo="Automat. Oil +3",
	    head=Herc_Repair.Head,																													--8
		body=Artifact_Foire.Body,
		hands=Herc_Repair.Hands,																												--8
