...
function user_setup()
	...
	send_command('bind ^!@f1 gs c set JugMode BouncingBertha')	--M1G1
	send_command('bind ^!@f2 gs c set JugMode SultryPatrice')	--M1G2
	send_command('bind ^!@f3 ')	--M1G3
	send_command('bind ^!@f4 ')	--M1G4
	send_command('bind ^!@f5 input /ja "Call Beast" <me>')	--M1G5
	send_command('bind ^!@f6 input /ja "Bestial Loyalty" <me>')	--M1G6
	send_command('bind ^!@f7 ')	--M2G1
	send_command('bind ^!@f8 ')	--M2G2
	send_command('bind ^!@f9 ')	--M2G3
	send_command('bind ^!@f10 ')--M2G4
	send_command('bind ^!@f11 ')--M2G5
	send_command('bind ^!@f12 ')--M2G6
...
function init_gear_sets()
	...
	sets.precast.WS['Rampage'] = sets.precast.WS
	
	sets.precast.WS['Decimation'] = sets.precast.WS
	...
	sets.engaged = {
		...
		hands="Malignance Gloves",
		legs={ name="Valor. Hose", augments={'Accuracy+19 Attack+19','"Dbl.Atk."+5','STR+4','Attack+2',}},
		feet="Malignance Boots",
		neck="Shulmanu Collar",
		waist="Reiki Yotai",
		left_ear="Sherida Earring",
...
function job_precast(spell, action, spellMap, eventArgs)
	...
	if spell.english == 'Bestial Loyalty' or spell.english == 'Call Beast' then
		...
		elseif state.JugMode.value == 'SultryPatrice' then
...
function set_lockstyle(num)
	send_command('wait 6; input /lockstyleset '..num)
end