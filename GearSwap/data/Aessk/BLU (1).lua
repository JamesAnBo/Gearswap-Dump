...
function init_gear_sets()
    ...
    sets.midcast['Blue Magic'].Magical = {
		...
		legs={ name="Herculean Trousers", augments={'"Mag.Atk.Bns."+13','Pet: AGI+4','Weapon skill damage +5%','Mag. Acc.+8 "Mag.Atk.Bns."+8',}},
		feet={ name="Herculean Boots", augments={'Mag. Acc.+14 "Mag.Atk.Bns."+14','Enmity-2','STR+2','"Mag.Atk.Bns."+13',}},
		...
		back={ name="Cornflower Cape", augments={'MP+16','DEX+4','Accuracy+2',}},
	}
    ...
    sets.idle.Town = set_combine(sets.idle, {legs="Crimson Cuisses +1"})
