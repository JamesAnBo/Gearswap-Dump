...
function user_setup()
	...
	--state.MeleeSet = M{['description']='Melee Set', 'Leaden', 'Savage', 'Ranged', 'Multi', }					--'DT','Hybrid',
	...
	--send_command('bind @h gs c toggle MaxHP')
	send_command("bind @n hp all northern san d'oria 2")	--win n
	send_command("bind @m hp all selbina 1")				--win m	
