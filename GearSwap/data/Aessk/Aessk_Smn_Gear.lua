...
function user_setup()
    ...
    send_command('bind !` input /pet "Release" <me>')
...
function init_gear_sets()
    ...
    sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap +1",ammo="Impatiens",
		...
		body="Inyanga Jubbah +2",hands="Helios Gloves",ring1="Kishar Ring",ring2="Lebeche Ring",
    ...
    hands={ name="Merlinic Dastanas", augments={'Blood Pact Dmg.+9','Pet: STR+4','Pet: "Mag.Atk.Bns."+13',}},
    ...
    left_ring="Varar Ring +1",
    right_ring="Varar Ring +1",
    back={ name="Conveyance Cape", augments={'Summoning magic skill +3','Blood Pact Dmg.+5',}},}
    ...
    sets.idle.Avatar = {main="Nirvana",sub="Elan Strap +1",ammo="Sancus Sachet +1",head={ name="Glyphic Horn +1", augments={'Enhances "Astral Flow" effect',}},
    body="Con. Doublet +1",hands={ name="Amalric Gages +1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    legs="Assid. Pants +1",feet="Beck. Pigaches +1",neck="Smn. Collar +1",waist="Incarnation Sash",left_ear="Evans Earring",
    right_ear="Rimeice Earring",left_ring="Evoker's Ring",right_ring="Varar Ring +1",back="Conveyance Cape",}
		
    sets.idle.PDT.Avatar = {main="Nirvana",sub="Elan Strap +1",ammo="Sancus Sachet +1",head={ name="Glyphic Horn +1", augments={'Enhances "Astral Flow" effect',}},
    body="Con. Doublet +1",hands={ name="Amalric Gages +1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    legs="Assid. Pants +1",feet="Beck. Pigaches +1",neck="Smn. Collar +1",waist="Incarnation Sash",left_ear="Evans Earring",
    right_ear="Rimeice Earring",left_ring="Evoker's Ring",right_ring="Varar Ring +1",back="Conveyance Cape",}

    sets.idle.Spirit = {main="Nirvana",sub="Elan Strap +1",ammo="Sancus Sachet +1",head={ name="Glyphic Horn +1", augments={'Enhances "Astral Flow" effect',}},
    body="Con. Doublet +1",hands={ name="Amalric Gages +1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    legs="Assid. Pants +1",feet="Beck. Pigaches +1",neck="Smn. Collar +1",waist="Incarnation Sash",left_ear="Evans Earring",
    right_ear="Rimeice Earring",left_ring="Evoker's Ring",right_ring="Varar Ring +1",back="Conveyance Cape",}
		
    sets.idle.PDT.Spirit = {main="Nirvana",sub="Elan Strap +1",ammo="Sancus Sachet +1",head={ name="Glyphic Horn +1", augments={'Enhances "Astral Flow" effect',}},
    body="Con. Doublet +1",hands={ name="Amalric Gages +1", augments={'INT+12','Mag. Acc.+20','"Mag.Atk.Bns."+20',}},
    legs="Assid. Pants +1",feet="Beck. Pigaches +1",neck="Smn. Collar +1",waist="Incarnation Sash",left_ear="Evans Earring",
    right_ear="Rimeice Earring",left_ring="Evoker's Ring",right_ring="Varar Ring +1",back="Conveyance Cape",}
