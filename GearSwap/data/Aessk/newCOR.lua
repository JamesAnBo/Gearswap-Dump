...
function user_setup()
	...
	send_command('bind ^!1 cancel sneak; send windybreeze cancel sneak; send windybreeze sneak <me>; monomi <me>')		--ctrl alt 5
	send_command('bind ^!2 send windybreeze invisible <me>; tonko <me>')												--ctrl alt 6
	send_command('bind ^!3 cancel invisible; wait 1; send windybreeze cancel invisible')								--ctrl alt 7
	send_command('bind ^!4 send windybreeze follow aessk')																--ctrl alt 8
...
function init_gear_sets()
    ...
    sets.Kiting = {name="Carmine Cuisses +1"}
    ...
    sets.Fomalhaut_M = {main={name="Rostam", bag="wardrobe3"}, sub="Gleti's Knife", ranged="Fomalhaut"}
    ...
    sets.Ataktos = {main="Naegling", sub="Gleti's Knife", ranged="Ataktos"}
